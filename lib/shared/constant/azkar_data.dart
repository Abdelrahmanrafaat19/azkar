...
List<AzkarListModel> citationForMorning = [
  AzkarListModel(
      counter: 1,
      zekr:
  ...
  AzkarListModel(counter: 100, zekr: "سُبْحـانَ اللهِ وَبِحَمْـدِهِ"),
  AzkarListModel(counter: 100, zekr: "أسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ"),
];
